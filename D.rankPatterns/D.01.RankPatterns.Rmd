...
This is a test: I've just changed a script in my repos.
...
``` {r}
areas <- read.csv(paste0(path,"rawData/ForIDAreaCalc-long-2018.01.csv"), head=T)
areas.qs <- areas
...
save(rank.aggregates, file=paste0(path,"RDataFiles/summarizedRanks.RData"))
```
