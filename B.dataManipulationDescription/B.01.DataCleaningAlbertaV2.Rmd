...
#AlbertaMastermatrix$subregion.name[AlbertaMastermatrix$subregion.name=="0"]<-"Unidentified"
...
#AlbertaMastermatrix$standtype.name[AlbertaMastermatrix$standtype.name=="0"]<-"Unidentified"
...
``` {r}
ranks$Rating[ranks$Rating==999]<-"Unranked"
ranks$Rating[ranks$Rating==0]<-"Unranked"
...
countdata<-read.csv("RDataFiles/AlbertaPointCountsAndOffsetsfromhabitatcategoriesAug16.csv",header=T)#counts of individual species, offsets for individual species, habitat, footprint data per PKEY and SS (as of Aug.16, 2018)
extractedtocount<-read.csv("RDataFiles/AlbertapointsCdatacheckMay23.csv",header=T)#ForestID data extracted to SS back in May 2018
...
write.csv(merged2gether, file="RDataFiles/merged2gether.csv")#data check
