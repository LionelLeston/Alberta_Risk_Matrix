...
AlbertaMastermatrixB$ageclass<-factor(AlbertaMastermatrixB$ageclass, levels=c("Age 3-30 Y", "Age 31-60 Y", "Age 61-80 Y", "Age 81-100 Y", "Age 101-140 Y", "Age 141+"))
levels(AlbertaMastermatrixB$ageclass)#reorder levels

AlbertaMastermatrixB$tpr.name<-factor(AlbertaMastermatrixB$tpr.name, levels=c("Unproductive", "Fair", "Medium", "Good"))
levels(AlbertaMastermatrixB$tpr.name)#reorder levels 

AlbertaMastermatrixB$subregion.name <- factor(AlbertaMastermatrixB$subregion.name, levels=c("Alpine_Subalpine","AthabascaPlainALPAC","BorealSubarctic","CentralMixedwood","DryMixedwood","LowerBorealHighlands","LowerFoothills","Montane","NorthernMixedwood","UpperBorealHighlands","UpperFoothills","0"))
levels(AlbertaMastermatrixB$subregion.name)
AlbertaMastermatrixB$subregion.name[AlbertaMastermatrixB$subregion.name=="0",]<-"NA"
...
AlbertaMastermatrixB$standtype.name <- factor(AlbertaMastermatrixB$standtype.name, levels=c("Mixedwood_conifer","Mixedwood_decid","Mixedwood_decidPl","Mixedwood_decidSb","Mixedwood_decidSw","Mixedwood_Pl","Mixedwood_Sb","Mixedwood_Sw","pureBlackSpruce","pureConifer_allcon","pureConifer_Pl","pureConifer_Sx","PureHardwood","PurePine","pureWhiteSpruce","0")) # eliminates missing speciesgroup levels
levels(AlbertaMastermatrixB$standtype.name)
AlbertaMastermatrixB$standtype.name[AlbertaMastermatrixB$standtype.name=="0"]<-"NA"
