...
## Objective: 
This report describes a gap analysis of how well point counts collated by the Boreal Avian Modelling Project (BAM) in Alberta cover the different Forest Classes identified in the Nest Ranking Matrix, aka "Risk Matrix". 

These Matrix Forest Classes are defined as the full factorial combination of Natural Subregion, Stand Type, Age Class, and Timber Productivity Rating. The Risk matrix was created by forest companies in Alberta, and ranks were assigned to Forest Classes by STRIX Ecological Consulting. 

Hereafter, ForestID is used as code for "Matrix Forest Class"
...
# LIONEL: Move Step 1 (Load data and rbind) to the data processing script
...
# Step 2 also belongs in the data processing scripts. 
...
# Add more explanation here: why do we need to create age classes? Weren't age classes provided in the Forsite spatial file? 
...
# insert a step here to add in the columns with abbreviated factor levels. And generate the ForID and ForID_long
...
# For this step in my analysis, I calculated forest area and sampling effort for each ForID. 
