...
load(paste0(path, "RDataFiles/AlbertatotalBirds_withpreds.RData"))

dens_per_ForID$FinalRank[dens_per_ForID$FinalRank=="999"]<-"NA"
dens_per_ForID<-dens_per_ForID[!is.na(dens_per_ForID$FinalRank),]
dens_per_ForID$FinalRank<-as.numeric(dens_per_ForID$FinalRank)
dens_per_ForID<-dens_per_ForID[!dens_per_ForID$FinalRank==0,]
...
**Conclusion:** performance of rank for density depends on combination of bec and sp group.
