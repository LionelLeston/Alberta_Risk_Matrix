...
riskmatrixAVI2<-read.csv("rawData/GISfiles/May17RiskMatrixV3_SubrCM_AlpacAVI.below600K.csv", header=TRUE)
...
During some quality-checking, we discovered that Shape_Area and Shape_Length were reading as factors rather than numeric, which caused problems downstream. 
