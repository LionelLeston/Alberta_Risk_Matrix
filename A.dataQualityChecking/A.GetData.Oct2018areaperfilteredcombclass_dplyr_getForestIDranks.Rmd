...
```{r load, echo=FALSE}
riskmatrixAVI1<-read.csv("rawData/GISfiles/May17RiskMatrixV3_SubrCM_AlpacAVI.600Kplus.csv", header=TRUE)

riskmatrixAVI2<-read.csv("A.dataQualityChecking/GISfiles/May17RiskMatrixV3_SubrCM_AlpacAVI.below600K.csv", header=TRUE)

riskmatrixAVI3<-read.csv("rawData/GISfiles/May17RiskMatrixV3_SubrCM_noFMA.csv", header=TRUE)

riskmatrixAVI4<-read.csv("rawData/GISfiles/RiskMatrixV3attributetableSubregion0.csv", header=TRUE)

riskmatrixAVI5<-read.csv("rawData/GISfiles/RiskMatrixV3attributetableSubregionABandM.csv", header=TRUE)

riskmatrixAVI6<-read.csv("rawData/GISfiles/July11RiskMatrixV3_SubrCM_newANCtoMillar.csv", header=TRUE)

riskmatrixAVI7<-read.csv("rawData/GISfiles/July11RiskMatrixV3_SubrCM_newTolkoHighPrairieAndFootner.csv", header=TRUE)

riskmatrixAVI8<-read.csv("rawData/GISfiles/July11RiskMatrixV3_SubrCM_TolkoVanderwell.csv", header=TRUE)

riskmatrixAVI9<-read.csv("rawData/GISfiles/July11RiskMatrixV3_SubrCM_VanderwellContractorsFMA.csv", header=TRUE)

riskmatrixAVI10<-read.csv("rawData/GISfiles/July11RiskMatrixV3_SubrCM_WestFraserAndTolko.csv", header=TRUE)

riskmatrixAVI11<-read.csv("rawData/GISfiles/July11RiskMatrixV3_SubrCM_WestFraserSlaveLakeFMA.csv", header=TRUE)

riskmatrixAVI12<-read.csv("rawData/GISfiles/July11RiskMatrixV3_SubrCM_WeyerhauserGrandePrairie.csv", header=TRUE)

riskmatrixAVI13<-read.csv("rawData/GISfiles/July11RiskMatrixV3_SubrCM_WeyerhauserPembinaTimberland.csv", header=TRUE)

riskmatrixAVI14<-read.csv("rawData/GISfiles/RiskMatrixV3attributetableSubregionLBHandDM.csv", header=TRUE)

riskmatrixAVI15<-read.csv("rawData/GISfiles/RiskMatrixV3attributetableSubregionLFabove700K.csv", header=TRUE)

riskmatrixAVI16<-read.csv("rawData/GISfiles/RiskMatrixV3attributetableSubregionLFbelow700K.csv", header=TRUE)

riskmatrixAVI17<-read.csv("rawData/GISfiles/RiskMatrixV3attributetableSubregionNandU.csv", header=TRUE)
